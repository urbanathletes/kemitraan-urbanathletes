...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2022 at 07:08 PM
...
CREATE TABLE `contact_uses` (
  ...
  `investment` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `investments` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kode_inves` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(5, '2022_07_15_085426_create_contact_uses_table', 1),
(6, '2022_08_02_151907_create_investments_table', 2);
