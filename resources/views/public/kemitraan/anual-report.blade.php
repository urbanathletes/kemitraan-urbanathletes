<x-main_kemitraan>
  ...
  <div class="container my-8">
    ...
    <div class="mt-10 xl:w-96 text-xl">
      <label for="year" class="border border-black py-2 px-4 font-FuturaBold">
        <span>SELECT YEAR</span>
        <select id="year" class="ml-12 form-select inline max-w-max text-right outline-0 outline-none appearance-none w-full px-3 bg-clip-padding bg-no-repeatrounded transition ease-in-out m-0
    ...
    <div class="mt-8 grid lg:grid-cols-2">
      <div class="pl-4">
        <div class="flex justify-start relative">
          ...
          <h2 class="font-FuturaBold text-xl ml-16">JULY, 2022</h2>
        </div>
