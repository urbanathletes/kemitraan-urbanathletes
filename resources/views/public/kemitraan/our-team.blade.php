<x-main_kemitraan menu='WHY URBAN ATHLETES' subMenu='OUT TEAM'>
  {{-- @push('style')   
    @stack('style')
  @endpush --}}

  <div class="flex justify-center max-h-[30vh] lg:max-h-[40vh] relative">
    <img class="object-cover object-center w-full mx-auto" src="{{ url('image/franchise/our_teamHeader.jpg') }}" alt="Store Urban Athletes">
    <div class="absolute top-0 bottom-0 left-0 right-0 flex flex-col justify-center items-center bg-gradient-to-t from-black text-white">
      <div class="absolute bottom-0 max-w-max text-center pb-6">
        <h2 class="text-2xl font-FuturaBold pb-2 lg:pb-4">OUR TEAM</h2>
        {{-- <P>
  ...
  <div class="">
    ...
    <div class="container pt-6 grid grid-cols-1">
      <div class="md:pb-6 grid md:block">
        ...
        <div>
          <h1 class="font-FuturaBold text-3xl inline px-4 bg-yellow-primary">OUR FOUNDER</h1>
        ...
        <div class="mx-4 lg:flex lg:justify-around lg:space-x-8 xl:space-x-0">
          <div>
            <p class="font-FuturaBold">1997</p>
            <p class="mb-4">Sarjana Arsitektur UK Petra</p>
            <p class="font-FuturaBold">2015</p>
            <p class="mb-4">NLP Practitioner by Victor Chen</p>
            <p class="font-FuturaBold">2016</p>
            <p class="mb-4">Master of NLP by Victor Chen</p>
          </div>
          <div>
            <p class="font-FuturaBold">2017</p>
            <p class="">Master of Business Coach with NLP</p>
            <p class="mb-4">CROSSFIT L1 TRAINER Certified</p>
            <p class="font-FuturaBold">2019</p>
            <p class="mb-4">Precision Nutrition Level 1 Certified</p>
  ...
  <div class="bg-black bg-gradient-to-tr from-neutral-600">
    ...
    <div class="container grid grid-cols-1 gap-12 py-16 md:grid-cols-3 md:py-12">
      ...
      <div class="">
        <button onclick="teamImg(this)" data-team="EKO" class="relative group h-full">
          <img class="h-full" src="{{ url('/image/franchise/EkoTriyono.png') }}" alt="EKO TRIYONO Urban Athletes">
          <div class="absolute top-0 right-0 left-0 opacity-0 h-full flex justify-center items-center transition-all duration-300 font-FuturaBold bg-gradient-to-t from-neutral-900/75 text-white
          group-hover:opacity-100"
          >
            More Info
      ...
      <div class="">
        <button onclick="teamImg(this)" data-team="SYAMSUL"class="relative group h-full">
          <img class="h-full" src="{{ url('/image/franchise/AchmadSyamsulFahri.png') }}" alt="ACHMAD SYAMSUL FARIH Urban Athletes">
          <div class="absolute top-0 right-0 left-0 opacity-0 h-full flex justify-center items-center transition-all duration-300 font-FuturaBold bg-gradient-to-t from-neutral-900/75 text-white
          group-hover:opacity-100"
          >
            More Info
  ...
  <div class="hidden" id="detailTeam" data-team="SYAMSUL">
    <div class="text-left">
      <img class="lg:float-left md:max-w-md md:mx-auto px-6" src="{{ url('/image/franchise/AchmadSyamsulFahri.png') }}" alt="ACHMAD SYAMSUL FARIH Urban Athletes">
      <div class="font-Futura mt-6">
        <div class="mb-4">
          <div class="border-l-[8px] border-yellow-primary flex">
            <h2 class="text-5xl inline font-FuturaBold mb-2 pl-4">ACHMAD SYAMSUL FARIH</h2>
          </div>
        ...
        <ul class="py-4">
          ...
          <li><span>NASM Course In House Celebrity Fitness</span></li>
          <li><span>Boxing Kick Boxing Course In House Celebrity Fitness</span></li>
          <li><span>Functional and Accesaries Training in House Celebrity Fitness</span></li>
          <li><span>Personal Trainer Level 2 Celebrity Fitness</span></li>
          <li><span>Gold’s Gym Foundation</span></li>
          <li><span>ACSM Course In House Gold’s Gym</span></li>
          <li><span>ACE Course In House Gold’s Gym</span></li>
          <li><span>CPR Course In House Gold’s Gym</span></li>
  ...
  <div class="hidden" id="detailTeam" data-team="EKO">
    <div class="text-left">
      <img class="lg:float-left md:max-w-md md:mx-auto px-6" src="{{ url('/image/franchise/EkoTriyono.png') }}" alt="EKO TRIYONO Urban Athletes">
      <div class="font-Futura mt-6">
        <div class="mb-4">
          <div class="border-l-[8px] border-yellow-primary flex">
            <h2 class="text-5xl inline font-FuturaBold mb-2 pl-4">EKO TRIYONO</h2>
          </div>
  ...
  <div class="hidden" id="detailTeam" data-team="RIVO">
    <div class="text-left">
      <img class="lg:float-left md:max-w-md md:mx-auto px-6" src="{{ url('/image/franchise/NaungPudiRivoBarumalang.png') }}" alt="NAUNG PUDI MEI RIVO BARUMALANG Urban Athletes">
      <div class="font-Futura mt-6">
        <div class="mb-4">
          <div class="border-l-[8px] border-yellow-primary flex">
            <h2 class="text-5xl inline font-FuturaBold mb-2 pl-4">NAUNG PUDI MEI RIVO BARUMALANG</h2>
          </div>
          {{-- <h3 class="text-2xl font-FuturaBold">District Sales Manager</h3> --}}
        </div>
  ...
  <script>
    function teamImg (e) {
      let detailTeam = document.querySelectorAll('#detailTeam');
      detailTeam.forEach(detail => {
        if (detail.getAttribute('data-team') === e.getAttribute('data-team'))  {
          Swal.fire({
