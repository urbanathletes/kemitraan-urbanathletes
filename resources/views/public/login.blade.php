<x-main_web specialPageNoFooter=true>
    ...
    <div class="flex items-center justify-center h-screen">
      <div class="rounded-xl backdrop-blur-sm bg-white/20 w-full mx-8 sm:w-96 shadow-xl items-center">
        <div class="items-center justify-center flex py-4">
          <img class="w-28 opacity-100" src="{{ url('/image/web/logo/LOGO_UA_HITAM_TM.png') }}" alt="Urban Atlhetes">
        </div>
        <div class="flex justify-center">
          {{-- <form method="POST" action="{{ route('login') }}" class="w-full px-20 sm:px-8"> --}}
          <form method="" action="" class="w-full px-20 sm:px-8">
            @csrf
