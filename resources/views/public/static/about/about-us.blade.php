<x-main_web menu='ABOUT US' subMenu="PROFILE">
  <div class="bg-black-ua text-white">
    ...
    <div class="mt-8 items-center overflow-hidden min-w-full relative
      md:max-h-[50vh] md:flex md:justify-end
      lg:max-h-[60vh]
    ">
      <div class="md:absolute md:left-0 md:top-0 md:bottom-0 relative
        flex justify-center items-center w-[135%] md:w-[55%] overflow-hidden z-10" style="clip-path: polygon(0 0, 100% 0%, 75% 100%, 0% 100%);"
      >
        <img class="w-full object-cover mr-36 object-right
          md:mr-0 md:h-full lg:mr-20 xl:mr-0
        "
        src="{{ url('image/web/about/about_us/d.jpg') }}" alt="About Us Urban Athletes">
        <div class="absolute left-0 top-0 bottom-0
        bg-black bg-opacity-50
        md:hidden justify-center items-center md:w-[55%] overflow-hidden z-20" style="clip-path: polygon(0 0, 100% 0%, 75% 100%, 0% 100%);"
      >
      ...
      <div class="hidden md:absolute md:left-0 md:top-0 md:bottom-0
        bg-black bg-opacity-50
      ...
      <div class="md:w-[60%] md:h-80">
        <img class="h-full w-full object-cover object-center md:object-bottom lg:object-top " src="{{ url('image/web/footer/img_1.jpg') }}" alt="About Us Urban Athletes">
      </div>
    </div>
    ...
    <div class="container pt-8">
      <div class="uppercase grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="text-center my-4">
          <h2 class="text-6xl text-yellow-primary font-FuturaBold pb-2">22</h2>
          <p>Trainers</p>
        </div>
        <div class="text-center my-4">
          <h2 class="text-6xl text-yellow-primary font-FuturaBold pb-2">4</h2>
          <p>Branches</p>
        </div>
        <div class="text-center my-4">
    ...
    <div class="container mt-12">
      <div class="mb-4 max-w-max relative">
        <h2 class="text-3xl font-FuturaBold">OUR PROGRAM</h2>
