      ...
      <div class="my-4 flex flex-wrap justify-center">
        ...
        <div class="w-[200px] m-4 overflow-hidden shadow-lg">
          ...
          <div class="mx-2 text-black font-black">
            ...
            <p class="uppercase text-sm">Matras Yoga Rubber</p>
            <div class="my-2 border-t border-neutral-400 py-2">
              <p>RP. 400.000</p>
            </div>
          </div>
        ...
        <div class="w-[200px] m-4 overflow-hidden shadow-lg">
          ...
          <div class="mx-2 text-black font-black">
            ...
            <p class="uppercase text-sm">Shirf UA Spesial HUT</p>
            <div class="my-2 border-t border-neutral-400 py-2">
              <p>RP. 400.000</p>
            </div>
          </div>
        ...
        <div class="w-[200px] m-4 overflow-hidden shadow-lg">
          ...
          <div class="mx-2 text-black font-black">
            ...
            <p class="uppercase text-sm">Mini Towel</p>
            <div class="my-2 border-t border-neutral-400 py-2">
              <p>RP. 200.000</p>
            </div>
          </div>
        ...
        <div class="w-[200px] m-4 overflow-hidden shadow-lg">
          ...
          <div class="mx-2 text-black font-black">
            ...
            <p class="uppercase text-sm">Matras Yoga Ruber PU</p>
            <div class="my-2 border-t border-neutral-400 py-2">
              <p>RP. 350.000</p>
            </div>
          </div>
        ...
        <div class="w-[200px] m-4 overflow-hidden shadow-lg">
          ...
          <div class="mx-2 text-black font-black">
            ...
            <p class="uppercase text-sm">Shirf Falcon Edition</p>
            <div class="my-2 border-t border-neutral-400 py-2">
              <p>RP. 300.000</p>
            </div>
          </div>
