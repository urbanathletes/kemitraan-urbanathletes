<tbody class="text-white">
  <tr class="py-5 h-10">
    <td colspan="7" class="mx-1 border-b-2 border-yellow-primary relative">
      <div class="m-1 absolute -bottom-6 right-0 left-0 flex justify-center"><p class="py-1 w-36 text-center bg-black">MORNING</p></div>
    </td>
  </tr>
  <tr class="py-5 mb-10 ">
    <td colspan="7">
      ...
      <div class="grid grid-cols-7 w-full">
        @foreach ($classes as $class)
          @if($class['studio_id'] != 3 && $class['classes_time']['time_start'] <= '13:00:00')
            <div class="py-2 bg-black/50 shadow-md shadow-green-ua font-normal m-1 max-w-[168px]">
  ...
  <tr class="py-5 my-10 h-10">
    <td colspan="7" class="mx-1 border-b-2 border-yellow-primary relative">
      <div class="m-1 absolute -bottom-6 right-0 left-0 flex justify-center"><p class="py-1 w-36 text-center bg-black">EVENING</p></div>
    </td>
  </tr>
  <tr class="py-5 mb-10 ">
    <td colspan="7">
