<div class="bg-neutral-150 text-sm">
  ...
  <div class="container">
    <div class="border border-b-black lg:mr-16">
        ...
        <div class="space-y-2 px-4 py-2 lg:pl-8">
          ...
          <form class="py-2" action="" method="get">
            <div class="bg-yellow-primary p-1 w-max">
              ...
              <button class="px-4"><i class="fa-solid fa-angle-right"></i></button>
            </div>
          </form>
        </div>
      </div>
  ...
  <div class="relative">
    ...
    <div class="py-4 text-center text-white font-sans-serif bg-black">
