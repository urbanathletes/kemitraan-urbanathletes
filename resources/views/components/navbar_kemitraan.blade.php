        ...
        <div class="lg:tracking-widest lg:w-full">
          <ul class="lg:py-3 lg:flex lg:w-max lg:uppercase">
            ...
            " id="menu" data-menu="{{$menu ?? ''}}">
              ...
              " id="sub-menu">
                <div class="flex justify-between items-center" id="klik">
                  <span class="py-3 px-4 justify-between" id="klik">WHY URBAN ATHLETES</span>
            ...
            " id="menu" data-menu="{{$menu ?? ''}}">
              ...
              " id="sub-menu">
                <div class="flex justify-between items-center" id="klik">
                  <span class="py-3 px-4 justify-between" id="klik">INVESTORS</span>
                  <p class="lg:hidden px-4" id="sub-menu-icon">+</p>
                </div>
              </button>
              <ul class="bg-[#181720] transition-all duration-300
                ...
                -top-44 -z-10 
              " id="list-subMenu">
                <li class="uppercase py-2 lg:py-1 lg:my-2 pl-8 lg:pl-2 lg:pr-2 lg:mx-2 border-t lg:border-0 border-gray-600 text-white lg:text-black hover:text-yellow-primary hover:bg-black" menu-sub="{{ $subMenu ?? '' }}"><a href="#">ANUAL REPORT</a></li>
                <li class="uppercase py-2 lg:py-1 lg:my-2 pl-8 lg:pl-2 lg:pr-2 lg:mx-2 border-t lg:border-0 border-gray-600 text-white lg:text-black hover:text-yellow-primary hover:bg-black" menu-sub="{{ $subMenu ?? '' }}"><a href="#">PRESENTATION</a></li>
              </ul>
            </li>
            <li class="
              border-b-[1px] border-gray-600 hover:text-yellow-primary
