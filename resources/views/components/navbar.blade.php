      ...
      " id="nav-menu">
        <div class="font-RobotoMono tracking-widest">
          ...
          <ul class="md:py-3 md:flex md:w-max md:uppercase">
            ...
            " id="menu" data-menu="{{$menu ?? ''}}"><a href="{{ url('/home') }}"><span>Home</span></a></li>
            <li class="
            ...
            " id="menu" data-menu="{{$menu ?? ''}}">
              ...
              ">
                <li class="py-2 pl-8 md:pl-4 border-t border-gray-600" menu-sub="{{ $subMenu ?? '' }}"><a href="{{ url('/about-us') }}" class="text-white hover:text-orange-500">About US</a></li>
                <li class="py-2 pl-8 md:pl-4 border-t border-gray-600" menu-sub="{{ $subMenu ?? '' }}"><a href="{{ url('/our-philosophy') }}" class="text-white hover:text-orange-500">Our Philosophy</a></li>
                <li class="py-2 pl-8 md:pl-4 border-t border-gray-600" menu-sub="{{ $subMenu ?? '' }}"><a href="{{ url('/our-team') }}" class="text-white hover:text-orange-500">Out Team</a></li>
                <li class="py-2 pl-8 md:pl-4 border-t border-gray-600" menu-sub="{{ $subMenu ?? '' }}"><a href="{{ url('/support-structure') }}" class="text-white hover:text-orange-500">Support Structure</a></li>
              </ul>
            </li>
            <li class="
              py-3 px-4 border-b-[1px] border-gray-600 hover:text-orange-500
              md:px-4 md:border-y-0 md:hover:border-b-4 md:hover:border-orange-500
            " id="menu" data-menu="{{$menu ?? ''}}"><a href="{{ url('/contact-us') }}"><span>Contact Us</span></a></li>
          </ul>
        </div>
      </div>
    </div>
